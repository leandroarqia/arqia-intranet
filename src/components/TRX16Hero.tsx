  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', width: '100%', height: '72vh', minHeight: 500 }}>
        ...
        {/* ── card 1 — esquerda ── */}
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'flex-start', padding: '0 6vw', pointerEvents: 'none', zIndex: 3 }}>
        ...
        {/* ── card 2 — direita ── */}
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', padding: '0 6vw', pointerEvents: 'none', zIndex: 3 }}>
...
function CardContent({ tag, title, body, rows, accent }: {
  ...
  return (
    <>
      <div style={{ fontSize: 10, letterSpacing: '0.24em', textTransform: 'uppercase', color: accent, marginBottom: 12 }}>{tag}</div>
      <h2 style={{ fontSize: 'clamp(28px,3.5vw,42px)', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1.05, marginBottom: 14, color: '#fff' }}>{title}</h2>
      <p style={{ fontSize: 13, lineHeight: 1.8, color: '#6a7d90', marginBottom: 20 }}>{body}</p>
